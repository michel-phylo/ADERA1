...
os.chdir('/mnt/c/adera_malinki_grant/adera_files')
#os.system('ls ')
...
#%cd 3adera-pdf4
#enter new file name
path_adera= '/mnt/c/adera_malinki_grant/adera_files'
...
import json
sentence='wha is the reason behind brain inflammation ?'  
with open(name_of_json_adera,'r') as f:    
          datastore = json.load(f)
for n in range(2,3):#,len(datastore)):
    print(n)
